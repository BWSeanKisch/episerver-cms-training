...
namespace AlloyTraining.Models.Pages
{
    [ContentType(DisplayName = "StartPage",
        ...
        GUID = "ef3ba1ed-b1be-46bc-b207-213cdb456796",
    ...
    public class StartPage : SitePageData
    {
        ...
        [Display(
                  Name = "Heading",
                  Description = "TIf the Heading is not set, the page falls back to showing the Name..",
        ...
        [CultureSpecific]
        [Display(Name = "Main content area", Description = "Drag and drop images, blocks, and pages with partial templates.", GroupName = SystemTabNames.Content, Order = 30)]
